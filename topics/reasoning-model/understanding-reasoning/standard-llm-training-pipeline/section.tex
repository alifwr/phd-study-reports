...
\label{sec:standard-llm-training-pipeline}
...
To understand where reasoning models diverge, one must first understand the training pipeline in the Table~\ref{tab:llm-training-pipeline}.

\begin{table}[H]
  \centering
  \caption{LLM Training Pipeline.}
  \label{tab:llm-training-pipeline}
